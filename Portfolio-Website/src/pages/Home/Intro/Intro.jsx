...
const Intro = () => {
    ...
    const children = [
        ...
        I'm a tech enthusiastic person who loves and live to code and bypassing some simple securities. I work hard each and every day to expertise my skills and develop new skills.
        </p>,

        <p className="mytextcolorwhite mb-1x p">
        I am from San Pedro, Moncada, Tarlac but I was born in Namaltugan, Sudipen, La Union and I am an Igorot. 
        </p>,
